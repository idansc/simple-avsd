...
# input feature types
fea_type="vggish i3d_rgb_vgg19_4"


# network architecture
# multimodal encoder
enc_psize="64"  # dims of projection layers for input features
enc_hsize="0 0 0 0"    # dims of cell states (0: no LSTM layer)
...
# training params
num_epochs=6  # number of maximum epochs
